...
import requests
import pandas as pd
from SuperQuant.SQFetch.base import headers, _select_market_code
...
def SQ_fetch_get_stock_analysis(code):
    """
...
headers_em_OperationsRequired[
    'Referer'] = 'http://emweb.securities.eastmoney.com/PC_HSF10/OperationsRequired/Index?type=soft&code=sz300059'
