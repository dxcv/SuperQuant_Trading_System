...
class backtest():
    ...
    def __init__(self, start_time='2015-01-01', end_time='2018-09-24', init_cash=500000, code='RBL8', frequence=SQ.FREQUENCE.FIFTEEN_MIN):
    ...
    def before(self, *args, **kwargs):
        ...
        self.data_min = SQ.SQ_fetch_future_min_adv(
            self.code, self.start_time, self.end_time, frequence=self.frequence)

        self.data_day = SQ.SQ_fetch_future_day_adv(
            self.code, self.start_time, self.end_time)

        self.Broker = SQ.SQ_BacktestBroker()
    ...
    def main(self,  *arg, **kwargs):
        ...
        self.account = SQ.SQ_Account(allow_sellopen=True, allow_t0=True, account_cookie=self.backtest_cookie,
                                     market_type=SQ.MARKET_TYPE.FUTURE_CN, frequence=self.frequence, init_cash=self.init_cash)
