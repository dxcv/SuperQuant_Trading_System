...
from SuperQuant.SQSetting.SQLocalize import strategy_path
import datetime
import os
import sys
import requests
...
def SQ_SU_save_strategy(name, portfolio_cookie='default', account_cookie='default', version=1, if_save=False, if_web_request=False, webreuquestsurl='http://localhost:8010/backtest/write'):
...
if __name__ == '__main__':
    SQ_SU_save_strategy('test', if_save=True, if_web_request=True)
