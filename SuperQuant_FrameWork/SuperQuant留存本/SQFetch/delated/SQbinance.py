...
from SuperQuant.SQUtil.SQcrypto import TIMEOUT, ILOVECHINA
...
def SQ_fetch_binance_kline(symbol, start_time, end_time, frequency):
    datas = list()
    start_time *= 1000
    end_time *= 1000
...
if __name__ == '__main__':
    ...
    print(start * 1000)
    print(end * 1000)
    data = SQ_fetch_binance_kline("ETHBTC", start, end, '1d')
    print(len(data))
    print(data[0])
    print(data[-1])
