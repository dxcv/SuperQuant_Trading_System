...
def SQ_util_getBetweenMonth(from_date, to_date):
    """
    ...
    while begin_date <= end_date:
        ...
        begin_date = SQ_util_get_1st_of_next_month(begin_date)
    return(date_list)


def SQ_util_add_months(dt, months):
    """
...
def SQ_util_get_1st_of_next_month(dt):
    """
    获取下个月第一天的日期
    :return: 返回日期
    """
...
def SQ_util_getBetweenQuarter(begin_date, end_date):
    """
    #加上每季度的起始日期、结束日期
    """
    quarter_list = {}
    month_list = SQ_util_getBetweenMonth(begin_date, end_date)
