...
class SQ_DataStruct_Indicators():
    """
    指标的结构
    """
    ...
    def __repr__(self):
        return '< SQ_DATASTRUCT_INDICATOR FROM {} TO {} WITH {} CODES >'.format(self.data.index.levels[0][0], self.data.index.levels[0][-1], len(self.data.index.levels[1]))
