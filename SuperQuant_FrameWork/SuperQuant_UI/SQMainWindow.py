...
class SQMainWindow(QMainWindow, Ui_MainWindow):
    """
    ...
    def __init__(self, parent=None):
        ...
        @type QWidget
        """
        super(SQMainWindow, self).__init__(parent)
        self.setupUi(self)
    ...
    def on_pushButtonStockData_clicked(self):
        ...
        """
        # TODO: not implemented yet
        SQStockDataMainWindow(self).show()
